...
static Eigen::Isometry3d tf2isometry(const geometry_msgs::msg::Transform& trans) {
  Eigen::Isometry3d mat = Eigen::Isometry3d::Identity();
  mat.translation() = Eigen::Vector3d(trans.translation.x, trans.translation.y, trans.translation.z);
  mat.linear() = Eigen::Quaterniond(trans.rotation.w, trans.rotation.x, trans.rotation.y, trans.rotation.z).toRotationMatrix();
  return mat;
}
